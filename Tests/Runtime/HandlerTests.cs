...
namespace TetrisInv.Tests.Runtime
{
    public class TetrisInventoryHandlerTests
    {
        ...
        public void AddInventory_AddsInventoryToCollection()
        {
            ...
            var item = new ItemStack<TestItemType>(_testItemType1X1, 1, new Vector2Int(0, 0));
            bool result = newHandler.AddItemAtPosition(0, item);
        ...
        public void AddItemAtPosition_ValidIndex_AddsToSpecificInventory()
        {
            ...
            bool result = _handler.AddItemAtPosition(0, item);
        ...
        public void AddItemAtPosition_InvalidIndex_ThrowsException()
        {
            ...
            Assert.Throws<System.ArgumentOutOfRangeException>(() => 
                _handler.AddItemAtPosition(5, item));
        }
        ...
        public void AddItemAtPosition_ItemCannotBeAdded_ReturnsFalse()
        {
            ...
            var blockingItem = new ItemStack<TestItemType>(_testItemType2X2, 1, new Vector2Int(0, 0));
            _handler.AddItemAtPosition(0, blockingItem);
        ...
        public void GetItemOfType_SpecificInventory_ReturnsItemFromThatInventory()
        {
            ...
            _handler.AddItemAtPosition(0, item1);
            _handler.AddItemAtPosition(1, item2);
        ...
        public void AddAnywhere_SpecificInventorySuccess_ReturnsTrue()
        {
            ...
            bool result = _handler.AddAnywhere(item, 0);
        ...
        public void AddAnywhere_SpecificInventoryFull_ReturnsFalseAndTriggersOverflow()
        {
            ...
            for (int y = 0; y < 5; y++)
            {
                for (int x = 0; x < 5; x++)
                {
                    var fillItem = new ItemStack<TestItemType>(_testItemType1X1, _testItemType1X1.StackSize, new Vector2Int(x, y));
                    _inventory1.AddItemAtPosition(fillItem);
                }
            }
            
            var item = new ItemStack<TestItemType>(_testItemType1X1, 1, Vector2Int.zero);
        ...
        [Test]
        public void AddAnywhere_AllInventories_AddsToFirstAvailable()
        {
            // Fill inventory1 partially to make it less attractive
            var blockItem = new ItemStack<TestItemType>(_testItemType2X2, 1, new Vector2Int(0, 0));
            _handler.AddItemAtPosition(0, blockItem);
            
            var item = new ItemStack<TestItemType>(_testItemType1X1, 5, Vector2Int.zero);
            
            bool result = _handler.AddAnywhere(item, -1);
        ...
        public void AddAnywhere_AllInventoriesFull_ReturnsFalseAndTriggersOverflow()
        {
            ...
            for (int y = 0; y < 5; y++)
            {
                for (int x = 0; x < 5; x++)
                {
                    var fillItem1 = new ItemStack<TestItemType>(_testItemType1X1, _testItemType1X1.StackSize, new Vector2Int(x, y));
            ...
            for (int y = 0; y < 3; y++)
            {
                for (int x = 0; x < 3; x++)
                {
                    var fillItem2 = new ItemStack<TestItemType>(_testItemType1X1, _testItemType1X1.StackSize, new Vector2Int(x, y));
        ...
        public void RemoveAmountFromPosition_ValidParameters_RemovesAmount()
        {
            ...
            _handler.AddItemAtPosition(0, item);
        ...
        public void ReplaceItem_ValidParameters_ReplacesItem()
        {
            ...
            _handler.AddItemAtPosition(0, originalItem);
        ...
        public void OnItemOverflow_TriggeredWhenExpected()
        {
            ...
            _handler.AddAnywhere(testItem, 0);
        ...
        {
            var item1 = new ItemStack<TestItemType>(_testItemType1X1, 3, new Vector2Int(0, 0));
            var item2 = new ItemStack<TestItemType>(_testItemType2X2, 1, new Vector2Int(0, 0));
        ...
        public void SearchOperations_CheckCorrectOrder()
        {
            ...
            _handler.AddItemAtPosition(1, item2); // Add to second inventory first
            _handler.AddItemAtPosition(0, item1); // Add to first inventory second
